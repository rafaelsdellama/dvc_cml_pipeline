...
# dvc run -n evaluate -p evaluate.metrics -d src/evaluate.py -d model.pkl -d data/features --metrics-no-cache scores.json python3 src/evaluate.py model.pkl data/features scores.json cm_classes.csv
